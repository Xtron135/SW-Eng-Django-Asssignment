...
4. Upload Django Project to Github (Use token on profile -> settings -> developer settings instead of Github account apassword): https://codinggear.blog/how-to-upload-django-project-to-github/
